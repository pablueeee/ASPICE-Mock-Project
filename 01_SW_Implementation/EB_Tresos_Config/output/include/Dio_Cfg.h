...
/**
* @brief          Symbolic name for the port hLight_A.
*
*/
...
#define  DioConf_DioChannel_l_High_Beam ((uint16)0x000bU)
...
/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_r_Low_Beam ((uint16)0x0011U)
...
/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_flash_btn ((uint16)0x000eU)

/* ---------- sLight_LEDs ---------- */

/**
* @brief          Symbolic name for the port sLight_LEDs.
*
*/
#define DioConf_DioPort_sLight_LEDs  ((uint8)0x01U)

/**
* @brief          Symbolic name for the channel front_l.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_front_l ((uint16)0x0031U)

/**
* @brief          Symbolic name for the channel front_r.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_front_r ((uint16)0x002eU)

/**
* @brief          Symbolic name for the channel back_l.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_back_l ((uint16)0x002fU)

/**
* @brief          Symbolic name for the channel back_r.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_back_r ((uint16)0x0030U)

/* ---------- hLight_C ---------- */

/**
* @brief          Symbolic name for the port hLight_C.
*
*/
...
/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_hLight_btn ((uint16)0x004dU)

/**
* @brief          Symbolic name for the channel hLight_Beam_btn.
*
*/
...
/**
* @brief          Symbolic name for the port sLight_btns.
*
*/
#define DioConf_DioPort_sLight_btns  ((uint8)0x03U)

/**
* @brief          Symbolic name for the channel turn_l_btn.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_turn_l_btn ((uint16)0x0063U)

/**
* @brief          Symbolic name for the channel turn_r_btn.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_turn_r_btn ((uint16)0x0065U)

/**
* @brief          Symbolic name for the channel hazard_btn.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_hazard_btn ((uint16)0x006cU)

/* ---------- tLight ---------- */

/**
* @brief          Symbolic name for the port tLight.
*
*/
#define DioConf_DioPort_tLight  ((uint8)0x04U)

/**
* @brief          Symbolic name for the channel l_tLight.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_l_tLight ((uint16)0x0090U)

/**
* @brief          Symbolic name for the channel r_tLight.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_r_tLight ((uint16)0x008fU)

/**
* @brief          Symbolic name for the channel l_bLight.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_l_bLight ((uint16)0x008eU)

/**
* @brief          Symbolic name for the channel r_bLight.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_r_bLight ((uint16)0x008dU)

/**
* @brief          Symbolic name for the channel brake_btn.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_brake_btn ((uint16)0x0084U)

/**
* @brief          Symbolic name for the channel reverse_btn.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_reverse_btn ((uint16)0x0085U)
