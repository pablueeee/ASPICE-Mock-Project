...
*                                     FILE VERSION CHECKS
==================================================================================================*/
#if (FTM_COMMON_VENDOR_ID != MCL_VENDOR_ID_CFG)
    #error "Ftm_Common.h and CDD_Mcl_Cfg.h have different vendor ids"
#endif
    /* Check if header file and CDD_Mcl_Cfg header file are of the same Autosar version */
#if ((FTM_COMMON_AR_RELEASE_MAJOR_VERSION != MCL_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (FTM_COMMON_AR_RELEASE_MINOR_VERSION != MCL_AR_RELEASE_MINOR_VERSION_CFG) || \
     (FTM_COMMON_AR_RELEASE_REVISION_VERSION != MCL_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of CDD_Mcl_Cfg.h and Ftm_Common.h are different"
#endif
/* Check if header file and CDD_Mcl_Cfg header file are of the same software version */
#if ((FTM_COMMON_SW_MAJOR_VERSION != MCL_SW_MAJOR_VERSION_CFG) || \
     (FTM_COMMON_SW_MINOR_VERSION != MCL_SW_MINOR_VERSION_CFG) || \
     (FTM_COMMON_SW_PATCH_VERSION != MCL_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of CDD_Mcl_Cfg.h and Ftm_Common.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
