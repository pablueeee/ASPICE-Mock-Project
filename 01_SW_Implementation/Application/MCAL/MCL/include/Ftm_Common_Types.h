...
#define FTM_COMMON_TYPES_SW_PATCH_VERSION                4
/** @} */
...
/**
* @brief FTM predef-timer 0
*/
#define FTM_0_PREDEF    ((uint8)0x00)
/**
* @brief FTM predef-timer 1
*/
#define FTM_1_PREDEF    ((uint8)((uint8)(1U<<FTM_MOD_SHIFT) + (uint8)0x00))
/**
* @brief FTM predef-timer 2
*/
#define FTM_2_PREDEF    ((uint8)((uint8)(2U<<FTM_MOD_SHIFT) + (uint8)0x00))
/**
* @brief FTM predef-timer 3
*/
#define FTM_3_PREDEF    ((uint8)((uint8)(3U<<FTM_MOD_SHIFT) + (uint8)0x00))
/**
* @brief FTM predef-timer 4
*/
#define FTM_4_PREDEF    ((uint8)((uint8)(4U<<FTM_MOD_SHIFT) + (uint8)0x00))
/**
* @brief FTM predef-timer 5
*/
#define FTM_5_PREDEF    ((uint8)((uint8)(5U<<FTM_MOD_SHIFT) + (uint8)0x00))
/**
* @brief FTM predef-timer 6
*/
#define FTM_6_PREDEF    ((uint8)((uint8)(6U<<FTM_MOD_SHIFT) + (uint8)0x00))
/**
* @brief FTM predef-timer 7
*/
#define FTM_7_PREDEF    ((uint8)((uint8)(7U<<FTM_MOD_SHIFT) + (uint8)0x00))
