...
#define FTM_COMMON_SW_PATCH_VERSION_C                4
/**@}*/
...
==================================================================================================*/
        ...
        #endif
    #endif 
    #if ((FTM_COMMON_AR_RELEASE_MAJOR_VERSION_C != SILREGMACROS_AR_RELEASE_MAJOR_VERSION) || \
         (FTM_COMMON_AR_RELEASE_MINOR_VERSION_C != SILREGMACROS_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Ftm_Common.c and SilRegMacros.h are different"
    #endif

    #if ((FTM_COMMON_AR_RELEASE_MAJOR_VERSION_C != SCHM_MCL_AR_RELEASE_MAJOR_VERSION) || \
         (FTM_COMMON_AR_RELEASE_MINOR_VERSION_C != SCHM_MCL_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Ftm_Common.c and SchM_Mcl.h are different"
    #endif

#endif

#if (FTM_COMMON_VENDOR_ID_C != FTM_COMMON_VENDOR_ID)
    #error "Ftm_Common.c and Ftm_Common.h have different vendor IDs"
#endif
/* Check if source file and Ftm_Common header file are of the same Autosar version */
#if ((FTM_COMMON_AR_RELEASE_MAJOR_VERSION_C != FTM_COMMON_AR_RELEASE_MAJOR_VERSION) || \
     (FTM_COMMON_AR_RELEASE_MINOR_VERSION_C != FTM_COMMON_AR_RELEASE_MINOR_VERSION) || \
     (FTM_COMMON_AR_RELEASE_REVISION_VERSION_C != FTM_COMMON_AR_RELEASE_REVISION_VERSION) \
    )
#error "AutoSar Version Numbers of Ftm_Common.c and Ftm_Common.h are different"
#endif
/* Check if source file and Ftm_Common header file are of the same Software version */
#if ((FTM_COMMON_SW_MAJOR_VERSION_C != FTM_COMMON_SW_MAJOR_VERSION) || \
     (FTM_COMMON_SW_MINOR_VERSION_C != FTM_COMMON_SW_MINOR_VERSION) || \
     (FTM_COMMON_SW_PATCH_VERSION_C != FTM_COMMON_SW_PATCH_VERSION) \
    )
#error "Software Version Numbers of Ftm_Common.c and Ftm_Common.h are different"
#endif
...
)
{
    ...
    for (u8SyncModuleIndex = 0U; u8SyncModuleIndex < MCL_FTM_CHANNEL_NO; u8SyncModuleIndex++)
    {
        ...
        if ((uint8)((uint8)u16ElementSyncList & (uint8)(1U << u8SyncModuleIndex)) == (uint8)(1U << u8SyncModuleIndex))
        {
            ...
            u32FtmClkConfig[u8SyncModuleIndex] = REG_READ32(FTM_SC_ADDR32(u8SyncModuleIndex)) & FTM_SC_CLKS_MASK_U32;

            /* Stop clock */
            REG_RMW32(FTM_SC_ADDR32(u8SyncModuleIndex), FTM_SC_CLKS_MASK_U32, FTM_SC_CLKS_NO_CLOCKS_U32);
