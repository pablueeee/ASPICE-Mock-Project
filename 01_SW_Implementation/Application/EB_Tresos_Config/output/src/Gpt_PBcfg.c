...
extern void GptNotification_FTM(void);
/** @} */
...
static CONST(Gpt_ChannelConfigType, GPT_CONST) Gpt_InitChannelPB[1] =
{
    {   /*GptChannelConfiguration_0 configuration data*/
        ...
        &GptNotification_FTM, /* Channel notification */
        ...
        (Gpt_ChannelModeType)(GPT_CH_MODE_CONTINUOUS), /* Timer mode:continous/one-shot */
        {
            ...
            (Gpt_PrescalerType)(1U), /* FTM Clock divider */ 
            ...
            (Gpt_PrescalerType)(1U), /* FTM alternate Clock divider */ 
...
CONST(Gpt_ConfigType, GPT_CONST)  Gpt_Config =
{
    ...
    {
        GptConf_GptChannelConfiguration_GptChannelConfiguration_0, /*mapping of FTM_0_CH_0*/
